...
<body>
                                                        ...
                                                        <div class="row g-5">
                                                                    ...
                                                                    <li>
                                                                        <a href="service-details-3.html">
                                                                            <div class="single-service-menu">
                                                                                ...
                                                                                <div class="info">
                                                                                    <h5 class="title">Market Research
                                                                                    </h5>
                                                                                    <p class="details">
                                                                                        Elever Architecture is a
                                                                                        New-York-based studio on
                                                                                        modern...
                                                                                    </p>
                                                                                </div>
                                                                            </div>
                                                            ...
                                                            <div class="col-lg-4">
                                                                <div class="menu-thumb pl--20">
                                                                    <img src="assets/images/banner/24.webp"
                                                                        alt="">
                                                                </div>
                                                            </div>
                                                        </div>
    ...
    <div id="side-bar" class="side-bar header-two">
        ...
        <div class="rts-sidebar-menu-desktop">
            <a class="logo-1" href="index-2.html"><img class="logo" src="assets/images/logo/01.svg"
                    alt="finbiz_logo"></a>
                ...
                <ul class="mainmenu metismenu" id="mobile-menu-active">
                    <li class="has-droupdown">
                        ...
                        <ul class="submenu mm-collapse" style="height: 0px;">
                            <li><a href="index-2.html">Demo One</a></li>
    ...
    <script src="{{ asset('assets/js/plugins/popup.js') }}"></script>
